...
```sh
git clone git@github.com:Toinounet21/avalanchego.git
cd avalanchego
```
...
Download the [latest build](https://github.com/Toinounet21/avalanchego-mod/releases/latest) for your operating system and architecture.
