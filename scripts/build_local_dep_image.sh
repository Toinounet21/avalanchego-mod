...
AVALANCHE_REMOTE="git@github.com:Toinounet21/avalanchego.git"
CORETH_REMOTE="git@github.com:Toinounet21/coreth.git"
...
AVA_LABS_RELATIVE_PATH="src/github.com/Toinounet21"
EXISTING_GOPATH="$GOPATH"

export GOPATH="$SCRIPT_DIRPATH/.build_image_gopath"
WORKPREFIX="$GOPATH/src/github.com/Toinounet21"
